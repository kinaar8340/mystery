...
.gradio-container .myst-gravity-cube-panel.myst-gravity-panel-window.vqc-optics-panel {{
    ...
    display: grid !important;
    grid-template-rows: auto minmax(var(--myst-viewport-min-height, clamp(14rem, 42vh, 28rem)), 1fr) !important;
    grid-template-columns: minmax(0, 1fr) !important;
    align-content: stretch !important;
    align-items: stretch !important;
    box-sizing: border-box !important;
...
.gradio-container #mystery-viewport,
.gradio-container #mystery-viewport.block,
.gradio-container #mystery-viewport > .wrap,
.gradio-container #mystery-viewport .wrap,
...
.gradio-container .myst-cube-viewport-media #mystery-viewport .plot-container,
            ...
            with gr.Row(elem_classes=["myst-gravity-split"], equal_height=True):
                ...
                with gr.Column(
                    ...
                    with gr.Group(
                        ...
                        with gr.Column(
                            scale=1,
                            elem_classes=["myst-cube-viewport-media", "myst-cube-viewport-media-slot"],
                        ):
