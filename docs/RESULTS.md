...
**Structured-IC κ-robustness (July 2026):** uniform IC → κ\* ≈ 0.91, Δ% ≈ 0.005%; hopfion/helical → κ\* ≥ 0.92, Δ% ≈ 2–5% (not R-nullable by κ alone). Verify: `python scripts/pde_structured_ic_kappa_robustness.py`. See eigenstructure note §12.
